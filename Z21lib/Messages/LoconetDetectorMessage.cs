...
public class LoconetDetectorMessage() : Message(MessageType.LAN_LOCONET_DETECTOR)
{
    public required LoconetFeedbackType FeedbackType { get; init; }

    public required Address FeedbackAddress { get; init; }
