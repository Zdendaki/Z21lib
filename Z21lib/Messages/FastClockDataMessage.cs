...
public class FastClockDataMessage() : Message(MessageType.LAN_FAST_CLOCK_DATA)
{
    public required byte[] Header { get; init; } = [0x66, 0x25];

    public required DayOfWeek Day { get; init; }

    public required TimeOnly Time { get; init; }

    public required bool Stop { get; init; }

    public required bool Halt { get; init; }

    public required byte Rate { get; init; }

    public required FcSettings Settings { get; init; }

    public required byte XOR { get; init; }
