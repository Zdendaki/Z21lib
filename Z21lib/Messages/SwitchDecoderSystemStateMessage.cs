...
public class SwitchDecoderSystemStateMessage() : Message(MessageType.LAN_DECODER_SYSTEMSTATE_DATACHANGED_SWITCH)
{
    ...
    internal static SwitchDecoderSystemStateMessage Parse(ReadOnlySpan<byte> data)
    {
        return new SwitchDecoderSystemStateMessage
        {
