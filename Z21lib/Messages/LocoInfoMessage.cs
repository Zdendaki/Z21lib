...
public class LocoInfoMessage() : Message(MessageType.LAN_X_LOCO_INFO)
{
    public required LocoAddress Address { get; init; }

    public required DecoderMode Mode { get; init; }

    public required bool Busy { get; init; }

    public required LocoSpeed Speed { get; init; }

    public required bool DoubleTraction { get; init; }

    public required bool SmartSearch { get; init; }

    public required bool Light { get; init; }
